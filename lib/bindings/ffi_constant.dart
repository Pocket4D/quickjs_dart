class JSFlags {
  ...
  static const JS_PROP_C_W_E = JS_PROP_CONFIGURABLE | JS_PROP_WRITABLE | JS_PROP_ENUMERABLE;
  static const JS_PROP_LENGTH = 1 << 3; /* used internally in Arrays */
  static const JS_PROP_TMASK = 3 << 4; /* mask for NORMAL, GETSET, VARREF, AUTOINIT */
  ...
  static const JS_EVAL_TYPE_INDIRECT = 3 << 0; /* indirect call (internal use) */
